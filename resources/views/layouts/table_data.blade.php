            ...
            <tr>
                @foreach($fieldNames as $fieldName)
                    ...
                    @if ($fieldName === 'accountName')
                        <td><a href="/campaign-report/{{isset($report['engine']) ? $report['engine'] : ''}}/{{isset($report['accountid']) ? $report['accountid'] : ''}}">{{ $report[$fieldName] }}</a></td>
                    @elseif ($fieldName === 'campaignName')
                        <td><a href="/adgroup-report/{{isset($report['engine']) ? $report['engine'] : ''}}/{{isset($report['accountid']) ? $report['accountid'] : ''}}/{{isset($report['campaignId']) ? $report['campaignId'] : ''}}">{{ $report[$fieldName] }}</a></td>
                    @elseif ($fieldName === 'adgroupName')
                        <td><a href="/keyword-report/{{isset($report['engine']) ? $report['engine'] : ''}}/{{isset($report['accountid']) ? $report['accountid'] : ''}}/{{isset($report['campaignId']) ? $report['campaignId'] : ''}}/{{isset($report['adgroupID']) ? $report['adgroupID'] : ''}}">{{ $report[$fieldName] }}</a></td>

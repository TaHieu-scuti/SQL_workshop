...
class RepoYssSearchqueryReportCost extends AbstractYssReportModel
{
    protected $table = 'repo_yss_searchquery_report_cost';
    ...
    protected function updateTemporaryTableWithConversion(
        ...
        foreach ($conversionNames as $key => $conversionName) {
            $convModel = new RepoYssSearchqueryReportConv();
            $queryGetConversion = $convModel->select(
                array_merge(
                    [DB::raw('SUM(repo_yss_searchquery_report_conv.conversions) AS conversions')],
                    $this->groupBy
                )

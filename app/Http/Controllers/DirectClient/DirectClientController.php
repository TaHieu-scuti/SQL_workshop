...
namespace App\Http\Controllers\DirectClient;
...
class DirectClientController extends AbstractReportController
{
    ...
    const SESSION_KEY_PREFIX_ROUTE = '/direct-client-report';
    ...
    /**
     * @var \App\Model\DirectClient
     */
    protected $model;

    /**
     * DirectClientController constructor.
     *
     * @param ResponseFactory          $responseFactory
     * @param DirectClient $model
     */

...
class CreateRepoYssPrefectureReportCostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('repo_yss_prefecture_report_costs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('repo_yss_prefecture_report_costs');
    }
}

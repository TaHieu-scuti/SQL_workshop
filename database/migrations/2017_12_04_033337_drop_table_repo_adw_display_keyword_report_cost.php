...
class DropTableRepoAdwDisplayKeywordReportCost extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::create(
            'repo_adw_display_keyword_report_costs',
            function (Blueprint $table) {
                ...
                $table->double('allConv')
                    ->nullable()
                    ->comment(
                        'AdWordsが推進するコンバージョン数の最善の見積もり。ウェブサイト、クロスデバイス、
                ...
                $table->text('appFinalURL')
                    ->nullable()
                    ->comment(
                        'この行のメインオブジェクトの最終的なアプリURLのリスト。リストのエントリは、
                ...
                $table->text('mobileFinalURL')
                    ->nullable()
                    ->comment(
                        'この行のメインオブジェクトの最終的なモバイルURLのリスト。
                                UrlList要素はJSONリスト形式で返されます。'
                    );
                $table->text('finalURL')
                    ->nullable()
                    ->comment(
                        'この行の主要オブジェクトの最終的なURLのリスト。
                                 UrlList要素はJSONリスト形式で返されます。'
                    );
                ...
                $table->boolean('isRestricting')
                    ->nullable()
                    ->comment(
                        'trueの値は、基準タイプが入札単価とターゲティング制限に使用されていることを示します。
